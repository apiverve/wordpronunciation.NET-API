...
namespace APIVerve
{
    public class WordPronunciationAPIClient
    {
        ...
        public WordPronunciationAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public WordPronunciationAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(wordpronunciationQueryOptions options)
        {
            try
            {
                if (_isDebug)
